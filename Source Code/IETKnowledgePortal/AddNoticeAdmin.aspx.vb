...
Partial Class AddNoticeAdmin
    ...
    Protected Sub Add_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Add.Click
        Try
            ...
            For i = 0 To Me.Branch.Items.Count - 1
                ...
                End If
            Next
            SDS.InsertCommand = "insert into Notices values (" + id.ToString + " , '" + Me.Subject.Text + "' , '" + Me.Notice.Text + "' , GETDATE() , '" + uploadedby + "' , 'Administrator' , '" + Session("user").ToString + "' , '" + facultyvisibilitydepartment + "' , '" + studentvisibilityyear + "' , '" + studentvisibilitybranch + "')"
            SDS.DataSourceMode = SqlDataSourceMode.DataSet
            SDS.Insert()
            Response.Redirect("NoticeAddedAdmin.aspx")
    ...
    Protected Sub Cancel_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Cancel.Click
        Try
            Response.Redirect("NoticeBoardAdmin.aspx")
        Catch ex As Exception
