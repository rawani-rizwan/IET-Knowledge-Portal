...
Partial Class AddNoticeFaculty
    ...
    Protected Sub Add_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Add.Click
        Try
            ...
            sdr = SDS.Select(dssa)
            sdr.Read()
            Dim uploadedby As String = sdr("Name").ToString + ", " + sdr("Designation").ToString + ", " + sdr("Department").ToString
            ...
            For i = 0 To Me.Branch.Items.Count - 1
                ...
                End If
            Next
            SDS.InsertCommand = "insert into Notices values (" + id.ToString + " , '" + Me.Subject.Text + "' , '" + Me.Notice.Text + "' , GETDATE() , '" + uploadedby + "' , 'Faculty' , '" + Session("user").ToString + "' , '" + facultyvisibilitydepartment + "' , '" + studentvisibilityyear + "' , '" + studentvisibilitybranch + "')"
            SDS.DataSourceMode = SqlDataSourceMode.DataSet
            SDS.Insert()
            Response.Redirect("NoticeAddedFaculty.aspx")
    ...
    Protected Sub Cancel_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Cancel.Click
        Try
            Response.Redirect("NoticeBoardFaculty.aspx")
        Catch ex As Exception
