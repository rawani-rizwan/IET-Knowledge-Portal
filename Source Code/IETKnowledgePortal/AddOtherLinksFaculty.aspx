<%@ Page Language="VB" MasterPageFile="~/Faculty.master" AutoEventWireup="false" CodeFile="AddOtherLinksFaculty.aspx.vb" Inherits="AddOtherLinksFaculty" title="Add Link" %>
...
<asp:Label ID="HeadingLabel" runat="server" BackColor="#507CD1" ForeColor="White"
        ...
        Width="706px">Add Useful Link</asp:Label>
