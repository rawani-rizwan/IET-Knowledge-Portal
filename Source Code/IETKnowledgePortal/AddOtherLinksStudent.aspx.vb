...
Partial Class AddOtherLinksStudent
    ...
    Protected Sub Add_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Add.Click
        Try
            ...
            SDS.InsertCommand = "insert into Links values (" + id.ToString + " , 'Miscellaneous' , '" + Me.TitleText.Text + "' , '" + Me.Link.Text + "' , GETDATE() , '" + uploadedby + "' , 'Student' , '" + Session("user").ToString + "')"
