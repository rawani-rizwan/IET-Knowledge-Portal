...
Partial Class AddSuggestedReadingFaculty
    ...
    Protected Sub Add_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Add.Click
        Try
            ...
            SDS.InsertCommand = "insert into Links values (" + id.ToString + " , 'Reading' , '" + Me.TitleText.Text + "' , '" + Me.Link.Text + "' , GETDATE() , '" + uploadedby + "' , 'Faculty' , '" + Session("user").ToString + "')"
