<%@ Page Language="VB" MasterPageFile="~/Student.master" AutoEventWireup="false" CodeFile="AddSuggestedReadingStudent.aspx.vb" Inherits="AddSuggestedReadingStudent" title="Add Suggested Reading" %>
