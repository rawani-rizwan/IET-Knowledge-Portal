...
Partial Class AddSuggestedReadingStudent
    ...
    Protected Sub Add_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Add.Click
        Try
            ...
            SDS.InsertCommand = "insert into Links values (" + id.ToString + " , 'Reading' , '" + Me.TitleText.Text + "' , '" + Me.Link.Text + "' , GETDATE() , '" + uploadedby + "' , 'Student' , '" + Session("user").ToString + "')"
    ...
    Protected Sub Done_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Done.Click
        Try
            Response.Redirect("UsefulLinksStudent.aspx")
        Catch ex As Exception
