...
Partial Class ChangeAdminProfilePicture
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Update.Click
        Try
            If Options.SelectedIndex = 0 Then
                If Me.ImageUpload.HasFile Then
                    ...
                    If Me.ImageUpload.PostedFile.ContentLength < 5242880 Then
                        ...
                        SDS.SelectCommand = "select * from Administrator where User_Id='" + userid + "'"
                        sdr = SDS.Select(dssa)
                        sdr.Read()
                        ...
                        End If
                        Dim filename As String = "Administrator_" + sdr("User_Id").ToString + System.IO.Path.GetExtension(Me.ImageUpload.FileName)
                        ImageUpload.SaveAs(Server.MapPath("images/profile pictures/" + filename))
                        SDS.UpdateCommand = "update Administrator set Profile_Picture='~/images/profile pictures/" + filename + "' where User_Id='" + userid + "'"
            ...
            Else
                ...
                End If
                SDS.UpdateCommand = "update Administrator set Profile_Picture='~/images/profile pictures/no_profile.jpg' where User_Id='" + userid + "'"
                SDS.DataSourceMode = SqlDataSourceMode.DataSet
                SDS.Update()
                Response.Redirect("~/AdminHome.aspx")
            End If
