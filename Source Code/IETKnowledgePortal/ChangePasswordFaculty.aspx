<%@ Page Language="VB" MasterPageFile="~/Faculty.master" AutoEventWireup="false" CodeFile="ChangePasswordFaculty.aspx.vb" Inherits="ChangePasswordFaculty" title="Change Password" %>
...
<asp:Label ID="HeadingLabel" runat="server" BackColor="#507CD1" ForeColor="White"
    ...
    <asp:TextBox ID="CurrentPassword" runat="server" BackColor="#FBF99B" Style="left: 180px;
        position: absolute; top: 40px" TextMode="Password" Width="144px"></asp:TextBox>
