...
Partial Class ChangePasswordStudent
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Update.Click
        Try
            ...
            If sdr("Password").ToString = Me.CurrentPassword.Text Then
                ...
                SDS.UpdateCommand = "update Student set Password = '" + Me.Password.Text + "' where User_Id = '" + Session("user").ToString + "'"
                SDS.Update()
                Response.Redirect("StudentPasswordUpdated.aspx")
            Else
