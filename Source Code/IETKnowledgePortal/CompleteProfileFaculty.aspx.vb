...
Partial Class CompleteProfileFaculty
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            SDS.UpdateCommand = "update Faculty set First_Login ='false' where User_Id ='" + Session("user").ToString + "'"
            SDS.Update()
        Catch ex As Exception
