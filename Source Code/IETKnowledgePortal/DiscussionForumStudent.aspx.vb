...
Partial Class DiscussionForumStudent
    ...
    Protected Sub SetLiteral()
        Try
            ...
            While (b)
                ...
                Me.Literal1.Text = Me.Literal1.Text + "</tr>"
                Me.Literal1.Text = Me.Literal1.Text + "<tr></tr><tr></tr><tr>"
                Me.Literal1.Text = Me.Literal1.Text + "<td valign = ""top""><label style= ""font-size:small;"" >" + "Replies: " + sdr("Replies").ToString + "&nbsp;&nbsp;&nbsp;&nbsp;" + "<a href = ""ViewDiscussionStudent.aspx?TopicId=" + sdr("Id").ToString + """  style= ""color:blue"" >View Thread/Reply</a>"
                If sdr("Poster_Type").ToString = "Student" And sdr("Poster_Id").ToString = Session("user").ToString Then
                    Me.Literal1.Text = Me.Literal1.Text + "&nbsp;&nbsp;&nbsp;&nbsp;" + "<a href = ""DeleteDiscussionStudent.aspx?TopicId=" + sdr("Id").ToString + """  style= ""color:blue"" >Delete Thread</a>"
                End If
    ...
    Protected Sub PostTopic_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles PostTopic.Click
        Try
            ...
            End While
            id = id + 1
            SDS.InsertCommand = "insert into Discussion_Threads values (" + id.ToString + " , '" + Me.Discussion.Text + "' , GETDATE() , 'Student' , '" + Me.PosterName.Text + "' , '" + Me.PosterPosition.Text + "' , '" + Me.PosterId.Text + "' , 0)"
            SDS.Insert()
            Me.SetLiteral()
            Me.Discussion.Text = ""
