...
Partial Class DownloadsStudent
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Me.IsPostBack = False Then
                ...
                SDS.SelectCommand = "select * from Files where ((Uploader_Type ='Student') and (Uploader_Id ='" + Session("user").ToString + "')) or (( Student_Visibility_Year like '%" + year + "%') and (Student_Visibility_Branch like '%" + branch + "%')) order by Date_Uploaded desc"
            End If
            ...
            If i = -1 Then
                If Me.Category.SelectedValue <> "All" Then
                    If Me.UploadedBy.SelectedValue <> "All" Then
                        If Me.UploadedBy.SelectedValue <> "Student" Then
                            SDS.SelectCommand = " select * from Files where ((Category = '" + Me.Category.SelectedValue + "') and (Uploader_Type = '" + Me.UploadedBy.SelectedValue + "') and ( Student_Visibility_Year like '%" + year + "%') and (Student_Visibility_Branch like '%" + branch + "%')) and ((File_Name like '%" + Me.SearchBox.Text + "%') or (Uploaded_By like '%" + Me.SearchBox.Text + "%') or (Title like '%" + Me.SearchBox.Text + "%') or (Author like '%" + Me.SearchBox.Text + "%') or (Publisher like '%" + Me.SearchBox.Text + "%')) order by Date_Uploaded desc"
                        Else
                            SDS.SelectCommand = " select * from Files where ((Category = '" + Me.Category.SelectedValue + "') and (Uploader_Type = '" + Me.UploadedBy.SelectedValue + "') and ((( Student_Visibility_Year like '%" + year + "%') and (Student_Visibility_Branch like '%" + branch + "%')) or ((Uploader_Type ='Student') and (Uploader_Id ='" + Session("user").ToString + "')))) and ((File_Name like '%" + Me.SearchBox.Text + "%') or (Uploaded_By like '%" + Me.SearchBox.Text + "%') or (Title like '%" + Me.SearchBox.Text + "%') or (Author like '%" + Me.SearchBox.Text + "%') or (Publisher like '%" + Me.SearchBox.Text + "%')) order by Date_Uploaded desc"
                        End If

                    Else
                        SDS.SelectCommand = " select * from Files where ((Category = '" + Me.Category.SelectedValue + "') and ((( Student_Visibility_Year like '%" + year + "%') and (Student_Visibility_Branch like '%" + branch + "%')) or ((Uploader_Type ='Student') and (Uploader_Id ='" + Session("user").ToString + "')))) and ((File_Name like '%" + Me.SearchBox.Text + "%') or (Uploaded_By like '%" + Me.SearchBox.Text + "%') or (Title like '%" + Me.SearchBox.Text + "%') or (Author like '%" + Me.SearchBox.Text + "%') or (Publisher like '%" + Me.SearchBox.Text + "%')) order by Date_Uploaded desc"
                    End If
                ...
                Else
                    ...
                    Else
                        SDS.SelectCommand = " select * from Files where (((( Student_Visibility_Year like '%" + year + "%') and (Student_Visibility_Branch like '%" + branch + "%')) or ((Uploader_Type ='Student') and (Uploader_Id ='" + Session("user").ToString + "')))) and ((File_Name like '%" + Me.SearchBox.Text + "%') or (Uploaded_By like '%" + Me.SearchBox.Text + "%') or (Title like '%" + Me.SearchBox.Text + "%') or (Author like '%" + Me.SearchBox.Text + "%') or (Publisher like '%" + Me.SearchBox.Text + "%')) order by Date_Uploaded desc"
                    End If
                    Me.FilesData.Visible = True
                End If
            Else
    ...
    Protected Sub FilesData_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles FilesData.RowCommand
        Try
            ...
            If currentCommand = "details" Then
                ...
                Response.Redirect("FileDetailsStudent.aspx")
