<%@ Page Language="VB" MasterPageFile="~/Admin.master" AutoEventWireup="false" CodeFile="EditProfileAdmin.aspx.vb" Inherits="EditProfileAdmin" title="Edit Profile" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Content" Runat="Server">
    ...
    <asp:Label ID="UserId" runat="server" Style="left: 95px; position: absolute; top: 30px"></asp:Label>
    ...
    <asp:TextBox ID="Name" runat="server" BackColor="#FBF99B" Style="left: 95px;
        position: absolute; top: 70px" Width="144px"></asp:TextBox>
    ...
    <asp:Label ID="EmailLabel" runat="server" AssociatedControlID="Email" Style="left: 5px;
        vertical-align: middle; position: absolute; top: 150px; text-align: justify">Email Id:</asp:Label>
    ...
    <asp:Label ID="DesignationLabel" runat="server" AssociatedControlID="Designation" Style="left: 5px;
    ...
    <asp:Label ID="MobileLabel" runat="server" AssociatedControlID="Mobile" Style="left: 5px;
        ...
        Width="74px">Mobile No:</asp:Label>
    ...
    <asp:Button ID="Update" runat="server" Style="left: 5px; position: absolute; top: 230px"
        Text="Update" />
    <asp:Button ID="Cancel" runat="server" Style="left: 95px; position: absolute; top: 230px"
