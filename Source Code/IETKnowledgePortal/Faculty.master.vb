    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Try
                ...
                Dim selectcommand1 As SqlCommand = New SqlCommand("select * from Faculty where User_Id='" + userid + "'", con1)
                ...
                Me.Designation.Text = sdr1("Designation").ToString + ", " + sdr1("Department").ToString
                con1.Close()
