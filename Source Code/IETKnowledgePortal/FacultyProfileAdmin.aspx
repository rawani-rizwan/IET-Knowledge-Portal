<%@ Page Language="VB" MasterPageFile="~/Admin.master" AutoEventWireup="false" CodeFile="FacultyProfileAdmin.aspx.vb" Inherits="FacultyProfileAdmin" title="Faculty Profile" %>
...
<asp:Image ID="ProfilePicture" runat="server" Style="position: absolute; left: 550px; top: 40px;" Height="160px" Width="140px" ImageUrl="~/images/profile pictures/no_profile.jpg" />
    ...
    <br />
    &nbsp; &nbsp;&nbsp;
    <asp:Button ID="Delete" runat="server" Text="Delete Account" Width="106px" />
