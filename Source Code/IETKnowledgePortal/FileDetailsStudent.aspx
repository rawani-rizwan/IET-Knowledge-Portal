<%@ Page Language="VB" MasterPageFile="~/Student.master" AutoEventWireup="false" CodeFile="FileDetailsStudent.aspx.vb" Inherits="FileDetailsStudent" title="File Details" %>
...
<asp:Label ID="HeadingLabel" runat="server" Text="File Details" Width="706px" style="vertical-align: middle; text-align: center" BackColor="#507CD1" ForeColor="White"></asp:Label>
    ...
    &nbsp; &nbsp;&nbsp;&nbsp;<asp:Button ID="Delete" runat="server" Text="Delete File" Visible="False" />
    &nbsp; &nbsp; &nbsp;
