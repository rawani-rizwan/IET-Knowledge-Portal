<%@ Page Language="VB" MasterPageFile="~/Student.master" AutoEventWireup="false" CodeFile="FileUploadedStudent.aspx.vb" Inherits="FileUploadedStudent" title="File Upload" %>
...
<asp:Label ID="HeadingLabel" runat="server" BackColor="#507CD1" ForeColor="White"
    ...
    <asp:HyperLink ID="UploadAnother" runat="server" NavigateUrl="~/UploadStudent.aspx"
