...
Partial Class MySuggestionsAdmin
    Inherits System.Web.UI.Page

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Me.IsPostBack = False Then
                SDS.SelectCommand = "select * from Links where Uploader_Type = 'Administrator' and Uploader_Id = '" + Session("user").ToString + "' order by Date_Suggested desc"
            End If
