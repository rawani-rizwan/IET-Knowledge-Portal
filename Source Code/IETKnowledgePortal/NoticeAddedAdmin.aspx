<%@ Page Language="VB" MasterPageFile="~/Admin.master" AutoEventWireup="false" CodeFile="NoticeAddedAdmin.aspx.vb" Inherits="NoticeAddedAdmin" title="Notice Added" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Content" Runat="Server">
 <asp:Label ID="HeadingLabel" runat="server" BackColor="#507CD1" ForeColor="White"
    ...
    <asp:HyperLink ID="AddAnother" runat="server" NavigateUrl="~/AddNoticeAdmin.aspx"
