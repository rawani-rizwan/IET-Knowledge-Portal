<%@ Page Language="VB" MasterPageFile="~/Student.master" AutoEventWireup="false" CodeFile="NoticeAddedStudent.aspx.vb" Inherits="NoticeAddedStudent" title="Notice Added" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Content" Runat="Server">
 <asp:Label ID="HeadingLabel" runat="server" BackColor="#507CD1" ForeColor="White"
    ...
    <asp:HyperLink ID="AddAnother" runat="server" NavigateUrl="~/AddNoticeStudent.aspx"
