...
Partial Class PendingFacultyAccountRequests
    Inherits System.Web.UI.Page

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Me.IsPostBack = False Then
                SDS.SelectCommand = "select * from Faculty where Account_Status='notactivated' order by Date_Requested"
            End If
    ...
    Protected Sub AccountRequests_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles AccountRequests.RowCommand
        Try
            ...
            If currentCommand = "activate" Or currentCommand = "deny" Then
                ...
                SDS1.SelectCommand = "select Email_Id from Faculty where User_Id='" + UserID + "'"
                sdr = SDS1.Select(dssa)
                sdr.Read()
                email = sdr("Email_Id")
                If currentCommand = "activate" Then
                    SDS.DataSourceMode = SqlDataSourceMode.DataSet
                    SDS.UpdateCommand = "update Faculty set Account_Status='activated' where User_Id='" + UserID + "'"
                    SDS.Update()
                    ...
                    msg.IsBodyHtml = True
                    msg.Body = "Congratulations! Your IET Knowledge Portal faculty account '" + UserID + "' has been activated.<br><br>This is a system generated mail. Please do not reply to this mail."
                ...
                ElseIf currentCommand = "deny" Then
                    ...
                    msg.IsBodyHtml = True
                    msg.Body = "Your IET Knowledge Portal faculty account request '" + UserID + "' has been denied.<br><br>This is a system generated mail. Please do not reply to this mail."
                    Dim smtp As SmtpClient = New SmtpClient()
                    smtp.Host = "smtp.gmail.com"
                    smtp.Credentials = New System.Net.NetworkCredential("ietknowledgeportal@gmail.com", "knowledgeportal")
                    smtp.EnableSsl = True
