<%@ Page Language="VB" MasterPageFile="~/Admin.master" AutoEventWireup="false" CodeFile="ShowNoticeAdmin.aspx.vb" Inherits="ShowNoticeAdmin" title="View Notice" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Content" Runat="Server">
 <asp:Label ID="HeadingLabel" runat="server" Text="Notice Board" Width="706px" style="vertical-align: middle; text-align: center" BackColor="#507CD1" ForeColor="White"></asp:Label>
    ...
    <br />
    &nbsp; &nbsp;&nbsp;
    <asp:Button ID="Delete" runat="server" Text="Delete Notice" />
    &nbsp; &nbsp; &nbsp;
