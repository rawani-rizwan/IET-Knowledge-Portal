    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Try
                ...
                Dim selectcommand1 As SqlCommand = New SqlCommand("select * from Student where User_Id='" + userid + "'", con1)
                ...
                Me.Designation.Text = "Student, " + sdr1("Year").ToString + " Year, " + sdr1("Branch").ToString
                con1.Close()
