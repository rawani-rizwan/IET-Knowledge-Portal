<%@ Page Language="VB" MasterPageFile="~/Main.master" AutoEventWireup="false" CodeFile="StudentSignUp.aspx.vb" Inherits="StudentSignUp" title="Sign Up" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Content" Runat="Server">
    <asp:Label ID="SignUpLabel" runat="server" Style="vertical-align: middle; position: absolute;
        text-align: center; left: 0px; top: 0px;" Text="Sign Up Request" BackColor="#507CD1" ForeColor="White" Width="706px"></asp:Label> 
    <asp:Label ID="EnrolmentNoLabel" runat="server" AssociatedControlID="EnrolmentNo" Style="left: 5px;
        vertical-align: middle; position: absolute; top: 35px; text-align: justify" Width="98px">Enrollment No:</asp:Label>
    <asp:TextBox ID="EnrolmentNo" runat="server" BackColor="#FBF99B" Style="left: 140px;
        position: absolute; top: 35px" Width="144px"></asp:TextBox>
    <asp:RequiredFieldValidator ID="EnrolmentValidator" runat="server" ControlToValidate="EnrolmentNo"
        ErrorMessage="Enrollment No is required." Style="left: 290px; position: absolute;
        top: 35px" ToolTip="Enrollment No is required.">*</asp:RequiredFieldValidator>    
    <asp:Label ID="ScholarNoLabel" runat="server" AssociatedControlID="ScholarNo" Style="left: 350px;
        vertical-align: middle; position: absolute; top: 35px; text-align: justify">Scholar No:</asp:Label>
    <asp:TextBox ID="ScholarNo" runat="server" BackColor="#FBF99B" Style="left: 485px;
        position: absolute; top: 35px" Width="144px"></asp:TextBox>
    <asp:RequiredFieldValidator ID="ScholarValidator" runat="server" ControlToValidate="ScholarNo"
        ErrorMessage="Scholar No is required." Style="left: 635px; position: absolute;
        top: 35px" ToolTip="Scholar No is required.">*</asp:RequiredFieldValidator>
    ...
    <asp:Label ID="RollNoLabel" runat="server" AssociatedControlID="RollNo" Style="left: 350px;
        vertical-align: middle; position: absolute; top: 65px; text-align: justify">Roll No:</asp:Label>
    <asp:TextBox ID="RollNo" runat="server" BackColor="#FBF99B" Style="left: 485px; position: absolute;
        top: 65px" Width="144px"></asp:TextBox>
    <asp:RequiredFieldValidator ID="RollValidator" runat="server" ControlToValidate="RollNo"
        ErrorMessage="Roll No is required." Style="left: 635px; position: absolute;
        top: 65px" ToolTip="Roll No is required.">*</asp:RequiredFieldValidator>        
    ...
    <asp:Label ID="YearLabel" runat="server" AssociatedControlID="Year" Style="left: 350px;
        vertical-align: middle; position: absolute; top: 95px; text-align: justify">Year:</asp:Label>
    <asp:DropDownList ID="Year" runat="server" BackColor="#FBF99B" Font-Names="Times New Roman"
        Style="left: 485px; position: absolute; top: 95px" Width="150px">
    ...
    <asp:Label ID="BranchLabel" runat="server" AssociatedControlID="Branch" Style="left: 350px;
        vertical-align: middle; position: absolute; top: 125px; text-align: justify">Branch:</asp:Label>
    <asp:DropDownList ID="Branch" runat="server" BackColor="#FBF99B" Style="left: 485px;
        position: absolute; top: 125px" Width="151px">
    ...
    <asp:Label ID="EmailLabel" runat="server" AssociatedControlID="Email" Style="left: 350px;
        position: absolute; top: 155px; vertical-align: middle; text-align: justify;">Email Id:</asp:Label>
    <asp:TextBox ID="Email" runat="server" BackColor="#FBF99B" Style="left: 485px; position: absolute;
        top: 155px" Width="144px"></asp:TextBox>
    <asp:RequiredFieldValidator ID="EmailValidator" runat="server" ControlToValidate="Email"
        ...
        top: 155px" ToolTip="E-mail is required.">*</asp:RequiredFieldValidator>
    ...
    <asp:Label ID="MobileLabel" runat="server" AssociatedControlID="Mobile" Style="left: 350px;
        position: absolute; top: 185px; vertical-align: middle; text-align: justify;" Width="78px">Mobile No:</asp:Label>
    <asp:TextBox ID="Mobile" runat="server" BackColor="#FBF99B" Style="left: 485px; position: absolute;
        top: 185px" Width="144px"></asp:TextBox>
    <asp:RequiredFieldValidator ID="MobileValidator" runat="server" ControlToValidate="Mobile"
        ErrorMessage="Mobile no is required." Style="left: 635px; position: absolute; top: 185px"
    ...
    <asp:RangeValidator ID="MobileValidator1" runat="server" ControlToValidate="Mobile"
        ...
        MinimumValue="1000000000" Style="left: 485px; position: absolute; top: 214px; vertical-align: middle; text-align: justify;"
