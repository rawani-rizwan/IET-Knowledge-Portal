...
Partial Class UpdateSecurityInfoFaculty
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Update.Click
        Try
            ...
            SDS.UpdateCommand = "update Faculty set Security_Question ='" + Me.Question.Text + "', Security_Answer ='" + Me.Answer.Text + "' where User_Id='" + Session("user").ToString + "'"
            SDS.Update()
            Response.Redirect("FacultySecurityInfoUpdated.aspx")
