<%@ Page Language="VB" MasterPageFile="~/Faculty.master" AutoEventWireup="false" CodeFile="UsefulLinksFaculty.aspx.vb" Inherits="UsefulLinksFaculty" title="Useful Links" %>
...
<asp:Label ID="HeadingLabel" runat="server" BackColor="#507CD1" ForeColor="White"
    ...
    <asp:HyperLink ID="ViewSuggested" runat="server" Style="left: 150px; color: blue;
        position: absolute; top: 45px; text-decoration: underline" NavigateUrl="~/ViewSuggestedReadingsFaculty.aspx">View</asp:HyperLink>
    ...
    <asp:HyperLink ID="AddSuggested" runat="server" Style="left: 200px; color: blue;
        position: absolute; top: 45px; text-decoration: underline" NavigateUrl="~/AddSuggestedReadingFaculty.aspx">Add</asp:HyperLink>
    ...
    <asp:HyperLink ID="ViewOther" runat="server" Style="left: 150px; color: blue; position: absolute;
        top: 85px; text-decoration: underline" NavigateUrl="~/ViewOtherLinksFaculty.aspx">View</asp:HyperLink>
    ...
    <asp:HyperLink ID="AddOther" runat="server" Style="left: 200px; color: blue; position: absolute;
        top: 85px; text-decoration: underline" NavigateUrl="~/AddOtherLinksFaculty.aspx">Add</asp:HyperLink>
    <asp:HyperLink ID="mysuggestions" runat="server" NavigateUrl="~/MySuggestionsFaculty.aspx"
