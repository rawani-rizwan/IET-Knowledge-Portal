<%@ Page Language="VB" MasterPageFile="~/Student.master" AutoEventWireup="false" CodeFile="UsefulLinksStudent.aspx.vb" Inherits="UsefulLinksStudent" title="Useful Links" %>
...
<asp:Label ID="HeadingLabel" runat="server" BackColor="#507CD1" ForeColor="White"
    ...
    <asp:HyperLink ID="ViewSuggested" runat="server" Style="left: 150px; color: blue;
        position: absolute; top: 45px; text-decoration: underline" NavigateUrl="~/ViewSuggestedReadingsStudent.aspx">View</asp:HyperLink>
    ...
    <asp:HyperLink ID="AddSuggested" runat="server" Style="left: 200px; color: blue;
        position: absolute; top: 45px; text-decoration: underline" NavigateUrl="~/AddSuggestedReadingStudent.aspx">Add</asp:HyperLink>
    ...
    <asp:HyperLink ID="ViewOther" runat="server" Style="left: 150px; color: blue; position: absolute;
        top: 85px; text-decoration: underline" NavigateUrl="~/ViewOtherLinksStudent.aspx">View</asp:HyperLink>
    ...
    <asp:HyperLink ID="AddOther" runat="server" Style="left: 200px; color: blue; position: absolute;
        top: 85px; text-decoration: underline" NavigateUrl="~/AddOtherLinksStudent.aspx">Add</asp:HyperLink>
    <asp:HyperLink ID="mysuggestions" runat="server" NavigateUrl="~/MySuggestionsStudent.aspx"
