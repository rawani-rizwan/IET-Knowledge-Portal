...
Partial Class ViewDiscussionFaculty
    ...
    Protected Sub SetTopicLiteral()
        Try
            ...
            If sdr("Poster_Type").ToString = "Faculty" And sdr("Poster_Id").ToString = Session("user").ToString Then
                Me.Flag.Text = "1"
                Me.TopicLiteral.Text = Me.TopicLiteral.Text + "&nbsp;&nbsp;&nbsp;&nbsp;" + "<a href = ""DeleteDiscussionFaculty.aspx?TopicId=" + sdr("Id").ToString + """  style= ""color:blue"" >Delete Thread</a>"
            End If
    ...
    Protected Sub SetReplyLiteral()
        Try
            ...
            While (b)
                ...
                If (sdr("Poster_Type").ToString = "Faculty" And sdr("Poster_Id").ToString = Session("user").ToString) Or (Me.Flag.Text = "1") Then
                    Me.ReplyLiteral.Text = Me.ReplyLiteral.Text + "</tr>"
                    Me.ReplyLiteral.Text = Me.ReplyLiteral.Text + "<tr></tr><tr></tr><tr>"
                    Me.ReplyLiteral.Text = Me.ReplyLiteral.Text + "<td valign = ""top""><label style= ""font-size:small;"" >"
                    Me.ReplyLiteral.Text = Me.ReplyLiteral.Text + "<a href = ""DeleteReplyFaculty.aspx?ReplyId=" + sdr("Id").ToString + "&TopicId=" + sdr("Topic_Id").ToString + """  style= ""color:blue"" >Delete Reply</a>"
    ...
    Protected Sub PostReply_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles PostReply.Click
        Try
            ...
            End While
            id = id + 1
            SDS.InsertCommand = "insert into Replies values (" + id.ToString + " , " + Me.TopicId.Text + " , '" + Me.Reply.Text + "' , GETDATE() , 'Faculty' , '" + Me.PosterName.Text + "' , '" + Me.PosterPosition.Text + "' , '" + Me.PosterId.Text + "')"
            SDS.Insert()
