<%@ Page Language="VB" MasterPageFile="~/Admin.master" AutoEventWireup="false" CodeFile="ViewOtherLinksAdmin.aspx.vb" Inherits="ViewOtherLinksAdmin" title="Useful Links" %>
...
<asp:Label ID="HeadingLabel" runat="server" BackColor="#507CD1" ForeColor="White"
    ...
    <asp:TextBox ID="SearchBox" runat="server" Style="left: 0px;
        ...
        Width="439px" BackColor="#FBF99B"></asp:TextBox>
