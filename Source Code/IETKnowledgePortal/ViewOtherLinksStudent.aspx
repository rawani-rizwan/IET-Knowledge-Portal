<%@ Page Language="VB" MasterPageFile="~/Student.master" AutoEventWireup="false" CodeFile="ViewOtherLinksStudent.aspx.vb" Inherits="ViewOtherLinksStudent" title="Useful Links" %>
...
<asp:Label ID="HeadingLabel" runat="server" BackColor="#507CD1" ForeColor="White"
    ...
    <asp:DropDownList ID="SuggestedBy" runat="server" BackColor="#FBF99B" Style="left: 550px;
        ...
        <asp:ListItem>Administrator</asp:ListItem> </asp:DropDownList>
