<%@ Page Language="VB" MasterPageFile="~/Admin.master" AutoEventWireup="false" CodeFile="ViewSuggestedReadingsAdmin.aspx.vb" Inherits="ViewSuggestedReadingsAdmin" title="Suggested Readings" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Content" Runat="Server">
 <asp:Label ID="HeadingLabel" runat="server" BackColor="#507CD1" ForeColor="White"
    ...
    <asp:TextBox ID="SearchBox" runat="server" Style="left: 0px;
        ...
        Width="437px" BackColor="#FBF99B"></asp:TextBox>
