<%@ Page Language="VB" MasterPageFile="~/Student.master" AutoEventWireup="false" CodeFile="ViewSuggestedReadingsStudent.aspx.vb" Inherits="ViewSuggestedReadingsStudent" title="Suggested Readings" %>
...
<asp:Label ID="HeadingLabel" runat="server" BackColor="#507CD1" ForeColor="White"
        ...
        Width="706px">Suggested Readings</asp:Label>
    ...
    <asp:TextBox ID="SearchBox" runat="server" Style="left: 0px;
        ...
        Width="435px" BackColor="#FBF99B"></asp:TextBox>
